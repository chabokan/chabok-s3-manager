...
function createBucketItem(bucket) {
    ...
    div.innerHTML = `
        ...
        <div class="bucket-info">
            ...
            <div class="bucket-meta">Created: ${date}</div>
        </div>
        <div class="bucket-actions">
            ...
            <button class="action-btn delete-btn" onclick="deleteBucket('${escapeHtml(bucket.name)}')">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
...
function createFileItem(item) {
    ...
    div.innerHTML = `
        ...
        <div class="file-actions">
            ...
            ` : ''}
            <button class="action-btn delete-btn" onclick="deleteItem('${escapeHtml(item.fullPath)}', ${isFolder})">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                    <path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m3 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6h14z" stroke="currentColor" stroke-width="2"/>
                </svg>
                Delete
